# Repositório do Projeto Tech News - Eletiva Python 

Este é o terceiro Projeto da eletiva de Python da Trybe (escola de programação).

<details>
  <summary><strong>👨‍💻 O que foi desenvolvido</strong></summary><br />

  Este projeto tem como principal objetivo fazer consultas e raspagem de dados em notícias sobre tecnologia.
...
<details>
  <summary><strong>⚠ Como acessar as funcionalidades do projeto:</strong></summary><br />

  1. Clone o repositório

* Use o comando: `git clone git@github.com:tryber/python-029-python-projeto-tech-news.git`
* Entre na pasta do repositório que você acabou de clonar:
  * `cd python-029-python-projeto-tech-news`
...
<details>
  ...
  ```
  Legenda:
  🔸Arquivos que não puderam ser alterados
...
<details>
  ...
  Para a realização deste projeto, utilizou-se um banco de dados chamado `tech_news`.
  As notícias serão armazenadas em uma coleção chamada `news`.
  Já existiam algumas funções prontas no arquivo `tech_news/database.py` que me auxiliaram no desenvolvimento.
...
# Requisitos obrigatórios solicitados para a conclusão do projeto

Neste projeto, construi um sistema de busca de notícias sobre tecnologia. Para isso, realizei a raspagem de dados do blog da Trybe e armazenei estas notícias em um banco de dados MongoDB.

Preparei uma interface em linha de comando (CLI) para você usar o seu sistema de busca. Esta CLI já está pronta, e você não precisará alterá-la. Para usá-la, basta instalar as dependências e executar o seguinte comando no terminal:

```bash
tech-news-analyzer
```

Você poderá usar a CLI para atualizar o banco de notícias, e fazer buscas por notícias! 🎉
